    ...
    , m_midi(midi)
{
    ...
    if (m_manager) {
        ...
        // Same platform condition as the UlanziDialBackend alias: Android
        // defines Q_OS_LINUX but uses the no-op fallback backend, which has
        // no accessRequired signal.
