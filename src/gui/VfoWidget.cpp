...
bool VfoWidget::eventFilter(QObject* obj, QEvent* event)
{
    ...
    // keyboard for the desktop type-to-tune path. Not extended to
    // m_collapsedFreqLabel: the direct-entry edit box lives in
    // m_freqStack, which is hidden while collapsed (see below).
